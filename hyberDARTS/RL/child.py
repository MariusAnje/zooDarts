...
def build_graph(input_shape, arch_paras):
    ...
    for layer_paras in arch_paras:
        ...
        # pool_size = layer_paras['pool_size'] \    # this line deleted
        #     if 'pool_size' in layer_paras else 1  # this line deleted
        pool_size = 2 \
            if (sss == 2 or sss == 4 or sss == 6) else 1 # this line and above added
